...
No R data science blog would be complete without the obligatory introduction tutorial to the awesome Caret (**C**lassification **A**nd **RE**gression **T**raining) package written by Max Kuhn. Below is one of the first R markdown writeups that I ever wrote a few years back. It was part exercise in creating a reproducible report and part practice with using caret to build and evaluate models. I dug up my old R project and thought it would make a fitting first post to my personal site.  
