...
I will review and expand on the exploratory data analysis techniques, primarily using tsibble and feasts, learned during the aforementioned forecasting workshop within this post. I plan to explore time series modeling with Fable in a seperate post. 
...
```{r calendar_hourly, include=TRUE, echo = TRUE, fig.height=10}
